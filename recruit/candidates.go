...
func (c *API) GetCandidates(params map[string]zohoutils.Parameter) (data CandidatesResponse, err error) {
	endpoint := zohoutils.Endpoint{
		Name:         "candidates",
		URL:          fmt.Sprintf("https://recruit.zoho.%s/recruit/v2/%s", c.ZohoTLD, CandidatesModule),
...
func (c *API) GetCandidateRelatedRecords(params map[string]zohoutils.Parameter, candidateId string, record RelatedRecord) (data CandidateRelatedRecordsResponse, err error) {
	endpoint := zohoutils.Endpoint{
		Name:         "candidates",
...
func (c *API) ListDeletedCandidates(params map[string]zohoutils.Parameter) (data DeletedCandidatesResponse, err error) {
	endpoint := zohoutils.Endpoint{
		Name:         "candidates",
