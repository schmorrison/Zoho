...
func (c *API) GetFieldsMetadata(params map[string]zohoutils.Parameter) (data FieldsMetadataResponse, err error) {
	endpoint := zohoutils.Endpoint{
		Name:         "metadata",
...
func (c *API) GetCustomViewsMetadata(moduleId string, params map[string]zohoutils.Parameter) (data CustomViewsMetadataResponse, err error) {
	endpoint := zohoutils.Endpoint{
		Name:         "metadata",
