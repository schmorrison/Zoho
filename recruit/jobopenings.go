...
func (c *API) GetJobOpenings(params map[string]zohoutils.Parameter) (data JobOpeningsResponse, err error) {
...
func (c *API) SearchJobOpenings(params map[string]zohoutils.Parameter) (data JobOpeningsResponse, err error) {
	endpoint := zohoutils.Endpoint{
		Name:         "jobopenings",
...
func (c *API) XMLSearchJobOpenings(params map[string]zohoutils.Parameter) (data JobOpeningsResponse, err error) {
	endpoint := zohoutils.Endpoint{
		Name:         "jobopenings",
...
func (c *API) XMLgetRecordById(params map[string]zohoutils.Parameter) (data JobOpening, err error) {
	endpoint := zohoutils.Endpoint{
		Name:         "jobopenings",
...
func (c *API) XMLGetRecords(params map[string]zohoutils.Parameter) (data XMLGetRecordsResponse, err error) {
	endpoint := zohoutils.Endpoint{
		Name:         "jobopenings",
		URL:          fmt.Sprintf("https://recruit.zoho.%s/recruit/private/xml/%s/getRecordById", c.ZohoTLD, JobOpeningsModule),
		Method:       zohoutils.HTTPGet,
